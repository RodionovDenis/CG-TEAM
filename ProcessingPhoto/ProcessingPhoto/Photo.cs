...
namespace ProcessingPhoto
{
    public partial class Photo : Form
    {
        ...
        {
            LuminousEdgesFilter filter = new LuminousEdgesFilter();
            backgroundWorker1.RunWorkerAsync(filter);
        }
        ...
        private void коррекцияСОпорнымЦветомToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Filtres f11 = new CorrectionWithAReferenceColor(main);
        ...
        private void поворотToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form2 a = new Form2();
            a.ShowDialog();
            Filtres f6 = new Rotation(a.x, a.y, a.my);
        ...
        {
            Tiss tiss = new Tiss();
            backgroundWorker1.RunWorkerAsync(tiss);
        }
        ...
        private void вБинарноеИзображениеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ToBin bin = new ToBin();
